<div class="container">
    ...
    <input value="<?php if (isset($_SESSION['adresse1'])) {
        echo $_SESSION['adresse1'];
    } ?>" type="text" placeholder="1, rue de l'exemple" name="adresse1" id="adresse1">
    <p class="messageErreur messageErreurAdresse1"></p>
</div>

<div class="container">
    <label for="adresse2">Adresse 2 :</label>
    <input value="<?php if (isset($_SESSION['adresse2'])) {
        echo $_SESSION['adresse2'];
    } ?>" type="text" placeholder="Etage 2, Appt 28" name="adresse2" id="adresse2">
